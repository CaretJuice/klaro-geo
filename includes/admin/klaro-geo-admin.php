...
function klaro_geo_activate() {
	...
	$GLOBALS['klaro_geo_default_services'] = $klaro_geo_default_services;
	...
	if ( empty( $existing_services ) ) {
		...
		$service_settings->set( $klaro_geo_default_services );
...
function klaro_geo_get_config() {
	...
	} elseif ( isset( $legacy_settings['default_template'] ) ) {
	...
	if ( $user_country && isset( $country_settings[ $user_country ] ) ) {
	...
	} elseif ( $user_country && isset( $legacy_settings['countries'] ) && isset( $legacy_settings['countries'][ $user_country ] ) ) {
		...
		} elseif ( ! empty( $country_config['template'] ) ) {
